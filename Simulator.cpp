...
Instruction Simulator::getNextInstruction()
...
void Simulator::getTokens(string line,
			       string &opcode,
			       string *operand,
			       int &numOperands)
...
bool Simulator::isNumberString(string s)
...
int Simulator::cvtNumString2Number(string s)
...
bool Simulator::getOperands(Instruction &i, Opcode o, 
...
string Simulator::encode(Instruction i)
